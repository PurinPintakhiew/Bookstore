...
<div class="w3-main" style="margin-left:300px">
  ...
  <header id="portfolio">
    ...
    <div class="w3-container">
    <h1><b>สำนักพิมพ์</b></h1>
    <div class="w3-section w3-bottombar w3-padding-16">
      <span class="w3-margin-right">Filter:</span> 
      <a href="publisher" class="w3-button w3-black">ALL</a>
      <a href="addPublisher" class="w3-button w3-white">ADD</a>
    </div>
    </div>
  </header>
  ...
  <thead class="thead-dark">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>{{$publisher->addess}}</td>
        <td>{{$publisher->email}}</td>
        <td>{{$publisher->tel}}</td>
        <td>
            <a href="/edit-publisher/{{$publisher->id}}" class="btn btn-info">Edit</a>
            <a href="/delete-publisher/{{$publisher->id}}" class="btn btn-danger">Delete</a>
        </td>
      </tr>
        @endforeach
    </tbody>
